          ...
          <div className="mt-6">
            ...
            {book.isbn && book.isbn.length > 0 && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-xs bg-amber-500 hover:bg-amber-600 text-white px-3 py-1.5 rounded-full font-medium transition-colors duration-200 flex items-center"
              >
                <span>Buy on Amazon</span>
                <svg className="w-3.5 h-3.5 ml-1" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
